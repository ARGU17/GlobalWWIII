...
export async function bootLegacyUi(){
  ...
  await import("../js/map.js?v=6.0.0-r4");
  await import("../js/v51/ui.js?v=6.0.0-r4");
  await import("../js/v52/ui.js?v=6.0.0-r4");
  await import("../js/ui.js?v=6.0.0-r4");
  await import("../js/app.js?v=6.0.0-r4");
}
