...
Los recursos se solicitan con `?v=1.8.2`. No subas únicamente el ZIP: GitHub Pages no lo descomprime. Las cuentas son locales al navegador porque GitHub Pages no ejecuta un servidor de autenticación.
