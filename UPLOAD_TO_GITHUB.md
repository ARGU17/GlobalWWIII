# Subir NEXUS Global Strategic Command v5.4.0 a GitHub Pages

1. Abre la carpeta de Strategic Command v5.4.0.
...
Los recursos de arranque se solicitan con `?v=5.4.0-r1`. No omitas `compat/legacy-v52.bundle.js` ni los módulos `.mjs`. Las cuentas son locales al navegador porque GitHub Pages no ejecuta un servidor de autenticación.
