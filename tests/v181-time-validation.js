...
assert(html.includes("Strategic Command v5.1"), "La portada no muestra Strategic Command v5.1");

console.log(JSON.stringify({ok:true,version:"5.1.0-alpha",speeds:[1,2,4,16,32],delegatedControls:true,remainingTimeAware:true},null,2));
