...
assert(app.includes('nexus_alpha_v1_8_1_save'), "La clave de guardado no corresponde a v1.8.1");
...
assert(html.includes("Alpha v1.8.1"), "La portada no muestra v1.8.1");

console.log(JSON.stringify({ok:true,version:"1.8.1-alpha",speeds:[1,2,4,16,32],delegatedControls:true,remainingTimeAware:true},null,2));
