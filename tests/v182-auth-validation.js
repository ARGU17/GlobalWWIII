...
assert(html.includes('js/auth.js?v=1.8.2'),"El módulo de autenticación no se carga o carece de versión");
...
assert(app.includes("NEXUS_AUTH?.storageKey")&&app.includes("nexus_alpha_v1_8_2_save"),"Los guardados no están aislados por cuenta");
...
console.log(JSON.stringify({ok:true,version:"1.8.2-alpha",accounts:"local",passwords:"PBKDF2-SHA-256",iterations:150000,isolatedSaves:true},null,2));
