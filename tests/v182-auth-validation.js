...
assert(html.includes('js/auth.js?v=2.0.0-r6'),"El módulo de autenticación no se carga o carece de versión");
...
console.log(JSON.stringify({ok:true,version:"2.0.0-alpha",accounts:"local",passwords:"PBKDF2-SHA-256",iterations:150000,isolatedSaves:true},null,2));
